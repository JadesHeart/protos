...
type RegisterRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       // Почта юзера на регистрацию
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // Пароль юзера на регистрацию
}
...
type RegisterResponse struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // User_id по регистрации
}
...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               // Почта юзера на логирование
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // Пароль юзера на логирование
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` //ID приложение в которое юзер логиниться, их может быть множество
}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Token залогированного юзера
}
...
type IsAdminRequest struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` //ID юзера на проверку админ или нет
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x15, 0x70, 0x72, 0x6f, 0x6b, 0x6f, 0x66, 0x65, 0x76, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76,
